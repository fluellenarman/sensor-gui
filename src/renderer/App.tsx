...
export const App: Component<Record<string, never>> = () => {
	...
	function setSidebarContent(newElement?: JSX.Element, cleanup?: () => unknown) {
		cleanupSidebar()
	...
	const [getDragCallback, setDragCallback] = createSignal<(event: MouseEvent) => unknown>()
					...
					<SidebarContext.Provider value={{ setSidebar: setSidebarContent }}>
						...
						>
							<div class="w-screen h-screen flex bg-base-100">
								...
								<div class="size-full" onClick={() => setSidebarContent()}>
